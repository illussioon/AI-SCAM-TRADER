<template>
  ...
  import NEWSslider from './NEWS-slider.vue'
  import LiveTransaction from './live-transaction.vue'
  import Nesw from './news-main.vue'
  import CryptoLive from '././live-curse.vue'
