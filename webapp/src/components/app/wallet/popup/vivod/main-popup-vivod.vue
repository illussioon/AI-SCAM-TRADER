  ...
  >
    ...
    >
      ...
      <div style="margin: -4px 8px 0 8px;">
        <VivodHeader @close="closeModal" />
      </div>
      
      <div class="modal-body">
        <p class="text-white/70">Выберите способ вывода средств:</p>
        
        <!-- Здесь будет контент для вывода средств -->
        <div class="withdrawal-methods mt-4">
          <!-- Заглушка для методов вывода -->
          <div class="method-item">
            <p class="text-white">Банковская карта</p>
          </div>
          <div class="method-item">
            <p class="text-white">СБП (Система быстрых платежей)</p>
          </div>
          <div class="method-item">
            <p class="text-white">Криптовалюта</p>
          </div>
        </div>
      </div>
    </div>
...
<script setup>
import VivodHeader from './vivod-header.vue';
