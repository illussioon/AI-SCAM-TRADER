      ...
      >
        <div class="flex items-center gap-x-2">
          ...
          <svg 
            ...
            style="filter: drop-shadow(rgba(94, 255, 3, 0.4) 0px 0px 17.976px);"
          >
            <path 
              fill-rule="evenodd" 
              clip-rule="evenodd" 
